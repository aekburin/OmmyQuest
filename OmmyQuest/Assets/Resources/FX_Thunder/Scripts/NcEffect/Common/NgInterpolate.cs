 ...
 */
    ...
    */
    ...
    public static Function Ease(EaseType type) {
        ...
        Function f = null;
        switch (type) {
            case EaseType.Linear: f = NcInterpolate.Linear; break;
            case EaseType.EaseInQuad: f = NcInterpolate.EaseInQuad; break;
            case EaseType.EaseOutQuad: f = NcInterpolate.EaseOutQuad; break;
            case EaseType.EaseInOutQuad: f = NcInterpolate.EaseInOutQuad; break;
            case EaseType.EaseInCubic: f = NcInterpolate.EaseInCubic; break;
            case EaseType.EaseOutCubic: f = NcInterpolate.EaseOutCubic; break;
            case EaseType.EaseInOutCubic: f = NcInterpolate.EaseInOutCubic; break;
            case EaseType.EaseInQuart: f = NcInterpolate.EaseInQuart; break;
            case EaseType.EaseOutQuart: f = NcInterpolate.EaseOutQuart; break;
            case EaseType.EaseInOutQuart: f = NcInterpolate.EaseInOutQuart; break;
            case EaseType.EaseInQuint: f = NcInterpolate.EaseInQuint; break;
            case EaseType.EaseOutQuint: f = NcInterpolate.EaseOutQuint; break;
            case EaseType.EaseInOutQuint: f = NcInterpolate.EaseInOutQuint; break;
            case EaseType.EaseInSine: f = NcInterpolate.EaseInSine; break;
            case EaseType.EaseOutSine: f = NcInterpolate.EaseOutSine; break;
            case EaseType.EaseInOutSine: f = NcInterpolate.EaseInOutSine; break;
            case EaseType.EaseInExpo: f = NcInterpolate.EaseInExpo; break;
            case EaseType.EaseOutExpo: f = NcInterpolate.EaseOutExpo; break;
            case EaseType.EaseInOutExpo: f = NcInterpolate.EaseInOutExpo; break;
            case EaseType.EaseInCirc: f = NcInterpolate.EaseInCirc; break;
            case EaseType.EaseOutCirc: f = NcInterpolate.EaseOutCirc; break;
            case EaseType.EaseInOutCirc: f = NcInterpolate.EaseInOutCirc; break;
        }
        return f;
    }
