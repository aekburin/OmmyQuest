...
public class InteractiveConsole_Facebook : MonoBehaviour
{
	...
	public void OnUserAPI()
	{
		FB.API("me?fields=name,gender", Facebook.HttpMethod.GET, UserCallBack);
	}
	...
	{
		PlayerPrefs.SetString("Player_Name",fbname);
		PlayerPrefs.SetString("Player_Gender",fbgender);
		Debug.Log("Saved Profile Successed!!");
	}
    ...
    private IEnumerator TakeScreenshot() 
    {
        ...
        wwwForm.AddBinaryData("image", screenshot, "Ommy_Quest.png");
        wwwForm.AddField("message", "This is our first app :) #OmmyQuest");
